...
pub struct Palette {
    ...
    pub search_bar_fg: Option<ColorSpec>,
    pub search_bar_bg: Option<ColorSpec>,
    pub search_bar_cursor_fg: Option<ColorSpec>,
    pub search_bar_cursor_bg: Option<ColorSpec>,
...
impl Palette {
    pub fn overlay_with(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            search_bar_fg: overlay!(search_bar_fg),
            search_bar_bg: overlay!(search_bar_bg),
            search_bar_cursor_fg: overlay!(search_bar_cursor_fg),
            search_bar_cursor_bg: overlay!(search_bar_cursor_bg),
